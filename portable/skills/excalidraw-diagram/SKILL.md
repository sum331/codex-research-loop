...
description: >
  Create polished Excalidraw diagram JSON files for workflows, architecture,
  systems, concepts, arguments, and visual explanations. Trigger when the user
  asks for an Excalidraw diagram, whiteboard diagram, architecture map, flowchart,
  workflow visualization, concept map, or says 画图, 架构图, 流程图, 可视化.
---
