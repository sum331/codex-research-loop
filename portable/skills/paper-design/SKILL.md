...
name: paper-design
description: >
  Design and prototype in Paper Design (app.paper.design) via MCP: read/write
  artboards, import HTML/CSS, convert designs to React/Tailwind, sync design
  tokens, and use Paper Shaders (@paper-design/shaders-react) such as mesh
  gradient, fluted glass, liquid metal, god rays, halftone, grain gradient, and
  pulsing border. Trigger on Paper Design, paper.design, Paper MCP, artboard,
  design-to-code, Paper Shaders, shader UI, 设计稿, 原型设计, 视觉原型.
