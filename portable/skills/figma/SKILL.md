...
name: figma
description: >
  Use Figma MCP to fetch design context, screenshots, variables, assets, and
  translate Figma nodes into production code. Trigger when the task includes a
  Figma URL/file/node, node ID, design-to-code, implement this design, inspect
  design variables/assets, Figma MCP setup/debugging, or says Figma 设计稿,
  按设计实现, 从 Figma 还原页面.
---
