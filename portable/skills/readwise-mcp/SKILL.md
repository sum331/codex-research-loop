...
name: readwise-mcp
description: >
  Use Readwise/Reader MCP tools to access highlights, saved articles, Reader
  documents, reading library metadata, exports, and summaries. Trigger when the
  user asks about Readwise, Reader, highlights, saved articles, reading notes,
  quote extraction, reading-library search, or says 阅读摘录, Readwise 高亮,
  Reader 文章, 读书笔记.
---
