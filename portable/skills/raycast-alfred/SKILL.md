...
version: 1.0.0
description: >
  macOS launcher automation with Raycast extensions, Alfred workflows, script
  commands, snippets, clipboard tools, file search, window management, keyboard
  shortcuts, and app integrations. Trigger when the user asks to build/fix a
  Raycast extension, Alfred workflow, launcher command, productivity automation,
  clipboard/snippet workflow, or says Raycast, Alfred, 启动器, 快捷指令.
