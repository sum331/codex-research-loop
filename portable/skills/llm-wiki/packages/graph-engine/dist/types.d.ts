...
export declare const UNGROUPED_COMMUNITY_ID = "_none";
export declare const UNGROUPED_COMMUNITY_LABEL = "\u672A\u5206\u7EC4";
...
export type GraphNodeType = "entity" | "topic" | "source" | "comparison" | "synthesis" | "query" | string;
...
export declare const WORLD_PIN_COORDINATE_SPACE = "world";
export declare const LEGACY_PERCENT_PIN_COORDINATE_SPACE = "legacy-percent";
export type PinCoordinateSpace = typeof WORLD_PIN_COORDINATE_SPACE | typeof LEGACY_PERCENT_PIN_COORDINATE_SPACE;
export declare function isPinCoordinateSpace(value: unknown): value is PinCoordinateSpace;
...
export type SelectionActionId = "summarize_page" | "find_related_pages" | "quote_page" | "summarize_cluster" | "summarize_group" | "explore_group_relationships" | "find_knowledge_gaps" | "create_topic_page" | "why_no_connection" | "find_potential_bridges" | "compare_communities" | "explore_potential_links" | "compare_differences" | "link_island";
...
export type GraphSummaryPayload = GraphNodeSummaryPayload | GraphCommunitySummaryPayload | GraphGlobalOverviewPayload | GraphSearchResultsPayload | GraphExcludedObjectPayload | GraphUnavailableObjectPayload;
...
export interface GraphEngine {
    ...
    summarizeCommunity(id: CommunityId, options?: GraphSummaryOptions): GraphCommunitySummaryPayload | GraphUnavailableObjectPayload;
    ...
    summarizeExcludedObject(object: GraphSummaryObjectRef, reason: GraphExcludedObjectPayload["reason"], options?: GraphSummaryOptions): GraphExcludedObjectPayload;
    summarizeUnavailableObject(object: GraphSummaryObjectRef, reason: GraphUnavailableObjectPayload["reason"], options?: GraphSummaryOptions): GraphUnavailableObjectPayload;
    clearSelection(): void;
