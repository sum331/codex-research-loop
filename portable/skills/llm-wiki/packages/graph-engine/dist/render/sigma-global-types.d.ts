...
export interface SigmaGlobalCameraLike {
    ...
    animate?: (state: Partial<SigmaGlobalCameraState>, options?: {
        duration?: number;
        easing?: string;
    }) => unknown;
}
...
export interface SigmaGlobalSigmaLike {
    ...
    viewportToGraph?: (point: GraphScreenPoint) => {
        x: number;
        y: number;
    };
    viewportToFramedGraph?: (point: GraphScreenPoint) => {
        x: number;
        y: number;
    };
    graphToViewport?: (point: {
        x: number;
        y: number;
    }, override?: SigmaGlobalCoordinateConversionOverride) => GraphScreenPoint;
    refresh?: () => unknown;
...
//# sourceMappingURL=sigma-global-types.d.ts.map