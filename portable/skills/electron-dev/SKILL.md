...
name: electron-dev
description: >
  Electron desktop app development with React, TypeScript, Vite, IPC, preload
  bridges, BrowserWindow, tray/menu/window management, PTY terminals,
  WebRTC/audio, and electron-builder packaging. Trigger when the user asks to
  build/fix/package an Electron app, desktop app, IPC, preload, tray, PTY,
  terminal UI, native desktop integration, or says 桌面应用, Electron, 打包安装包.
---
